...
public sealed class PluginRootBuildFileGeneratorTests
{
    ...
    public async Task GenerateAsyncWritesDeterministicGeneratedFiles()
    {
        ...
        Assert.IsFalse(globalJson.Contains("// This file is generated by CodeAlta", StringComparison.Ordinal));
        using var parsedGlobalJson = JsonDocument.Parse(globalJson);
        Assert.AreEqual(PluginRootBuildFileGenerator.GeneratedJsonMarker, parsedGlobalJson.RootElement.GetProperty("_codealta").GetString());
