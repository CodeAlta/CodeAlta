...
public sealed class ArchitectureGuardrailTests
{
    ...
    public void FrontendCoordinators_DoNotAddUntrackedFireAndForgetTasks()
    {
        ...
        var allowedLegacySites = new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "App/ShellSessionStateCoordinator.cs:315:_ = PersistViewStateAsync();",
            "App/ShellSessionStateCoordinator.cs:387:_ = PersistViewStateAsync();",
            "App/ShellSessionStateCoordinator.cs:527:_ = PersistViewStateAsync();",
            "App/ShellSessionStateCoordinator.cs:577:_ = PersistViewStateAsync();",
            "App/SidebarCoordinator.cs:312:_ = CommitInlineRenameAsync(row, projectId, displayName, previousTitle);",
            "App/SessionPromptDispatchCoordinator.cs:179:_ = RecordResolvedReferenceUsageAsync(promptInput.ResolvedReferences);",
            ...
            "App/SessionRuntimeEventCoordinator.cs:277:Task.Run(async () =>",
            "App/SessionRuntimeEventCoordinator.cs:620:_ = InvalidateProjectFileSearchAsync(session.WorkingDirectory);",
            "Presentation/Editing/FileEditorTab.cs:222:_ = RefreshExternalStateAsync();",
