...
using CodexThread = CodeNoesis.CodexSdk.V2.Thread;
using V2AskForApproval = CodeNoesis.CodexSdk.V2.AskForApproval;
using V2UserInput = CodeNoesis.CodexSdk.V2.UserInput;

namespace CodeNoesis.Agent.Codex;
