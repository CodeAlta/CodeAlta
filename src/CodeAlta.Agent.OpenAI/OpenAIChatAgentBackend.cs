...
/// <summary>
/// Local-runtime backend for OpenAI-compatible Chat/Completions providers.
/// </summary>
public sealed class OpenAIChatAgentBackend : IAgentBackend, IAgentSharedSessionMetadataBackend
{
