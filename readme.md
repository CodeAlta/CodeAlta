...
- Press `Ctrl+O`, run `/open`, or use the always-visible `+` action on the `Projects` sidebar row to open a folder dialog with directory completion and add that folder to the project list (`CodeAlta`)
